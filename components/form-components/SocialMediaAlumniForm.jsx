...
const SocialMediaAlumniForm = () => {
    return (
        <div id="social_fields" className='w-full flex flex-col justify-center items-center mt-12'>
            <h1 className='mt-20 text-center font-bold text-transparent text-2xl sm:text-3xl bg-clip-text bg-gradient-to-r from-fuchsia-600 from-20% via-indigo-500 via-40% to-orange-400 to-90%'>Social Media Handles</h1>

            <p className="text-red-600 mb-2 text-sm tracking-wide text-center">Provide at least two social media links!</p>
            <hr className="border-gray-700 w-full mb-8" />

            <div className="w-full mt-5 flex justify-center flex-col md:flex-row">
            ...
            <div className="w-full mt-3 flex justify-center flex-col md:flex-row">
